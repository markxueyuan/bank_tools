...
⎡⎛
⎢⎜4⋅R_B⋅R_M⋅R_W⋅θ⋅λ⋅f(I) - 4⋅R_B⋅R_M⋅R_W⋅λ⋅f(I) + 2⋅R_B⋅R_M⋅θ⋅f(I) - 2⋅R_B⋅R_M
⎢⎜────────────────────────────────────────────────────────────────────────────
⎢⎜
⎣⎝

⋅f(I) - 8⋅R_B⋅R_W⋅θ⋅λ⋅r(L) + 8⋅R_B⋅R_W⋅λ⋅r(L) - 4⋅R_B⋅θ⋅r(L) + 4⋅R_B⋅r(L) - R_
──────────────────────────────────────────────────────────────────────────────


 2        2             2        2             2                      2
M ⋅R_W⋅θ⋅λ ⋅f(I) - 8⋅R_M ⋅R_W⋅θ⋅λ ⋅r(L) + 2⋅R_M ⋅R_W⋅θ⋅λ⋅f(I) + 16⋅R_M ⋅R_W⋅θ⋅
──────────────────────────────────────────────────────────────────────────────


            2      2             2      2             2                    2
λ⋅r(L) - R_M ⋅R_W⋅λ ⋅f(I) + 8⋅R_M ⋅R_W⋅λ ⋅r(L) + 2⋅R_M ⋅R_W⋅λ⋅f(I) - 16⋅R_M ⋅R
──────────────────────────────────────────────────────────────────────────────
                            ⎛     2    2        2  2          2
        (R_M⋅f(I) - 2⋅r(L))⋅⎝2⋅R_W ⋅θ⋅λ  - 2⋅R_W ⋅λ  - R_W⋅θ⋅λ  + 3⋅R_W⋅θ⋅λ -
                 2                 2                 2               2
_W⋅λ⋅r(L) - 4⋅R_M ⋅θ⋅λ⋅f(I) - 4⋅R_M ⋅θ⋅λ⋅r(L) + 8⋅R_M ⋅θ⋅f(I) + 8⋅R_M ⋅θ⋅r(L)
──────────────────────────────────────────────────────────────────────────────
     2                                ⎞
R_W⋅λ  + R_W⋅λ - 4⋅θ⋅λ + 8⋅θ + 2⋅λ - 4⎠
       2               2               2             2                     2
+ 2⋅R_M ⋅λ⋅f(I) + 4⋅R_M ⋅λ⋅r(L) - 4⋅R_M ⋅f(I) - 8⋅R_M ⋅r(L) + 2⋅R_M⋅R_W⋅θ⋅λ ⋅r
──────────────────────────────────────────────────────────────────────────────


                                      2
(L) - 4⋅R_M⋅R_W⋅θ⋅λ⋅r(L) + 2⋅R_M⋅R_W⋅λ ⋅r(L) - 4⋅R_M⋅R_W⋅λ⋅r(L) + 8⋅R_M⋅θ⋅λ⋅r(
──────────────────────────────────────────────────────────────────────────────


                                                  ⎛
L) - 16⋅R_M⋅θ⋅r(L) - 4⋅R_M⋅λ⋅r(L) + 8⋅R_M⋅r(L)  θ⋅⎝4⋅R_B⋅R_M⋅R_W⋅θ⋅λ⋅f(I) - 4⋅
──────────────────────────────────────────────, ──────────────────────────────



R_B⋅R_M⋅R_W⋅λ⋅f(I) + 2⋅R_B⋅R_M⋅θ⋅f(I) - 2⋅R_B⋅R_M⋅f(I) - 8⋅R_B⋅R_W⋅θ⋅λ⋅r(L) +
──────────────────────────────────────────────────────────────────────────────


                                                  2        2             2
8⋅R_B⋅R_W⋅λ⋅r(L) - 4⋅R_B⋅θ⋅r(L) + 4⋅R_B⋅r(L) - R_M ⋅R_W⋅θ⋅λ ⋅f(I) - 8⋅R_M ⋅R_W
──────────────────────────────────────────────────────────────────────────────


    2             2                      2                   2      2
⋅θ⋅λ ⋅r(L) + 2⋅R_M ⋅R_W⋅θ⋅λ⋅f(I) + 16⋅R_M ⋅R_W⋅θ⋅λ⋅r(L) - R_M ⋅R_W⋅λ ⋅f(I) + 8
──────────────────────────────────────────────────────────────────────────────
                                                                            ⎛
                                                        (R_M⋅f(I) - 2⋅r(L))⋅⎝2
    2      2             2                    2                   2
⋅R_M ⋅R_W⋅λ ⋅r(L) + 2⋅R_M ⋅R_W⋅λ⋅f(I) - 16⋅R_M ⋅R_W⋅λ⋅r(L) - 4⋅R_M ⋅θ⋅λ⋅f(I) -
──────────────────────────────────────────────────────────────────────────────
    2    2        2  2          2                    2
⋅R_W ⋅θ⋅λ  - 2⋅R_W ⋅λ  - R_W⋅θ⋅λ  + 3⋅R_W⋅θ⋅λ - R_W⋅λ  + R_W⋅λ - 4⋅θ⋅λ + 8⋅θ +
      2                 2               2               2               2
 4⋅R_M ⋅θ⋅λ⋅r(L) + 8⋅R_M ⋅θ⋅f(I) + 8⋅R_M ⋅θ⋅r(L) + 2⋅R_M ⋅λ⋅f(I) + 4⋅R_M ⋅λ⋅r(
──────────────────────────────────────────────────────────────────────────────
        ⎞
 2⋅λ - 4⎠
          2             2                     2
L) - 4⋅R_M ⋅f(I) - 8⋅R_M ⋅r(L) + 2⋅R_M⋅R_W⋅θ⋅λ ⋅r(L) - 4⋅R_M⋅R_W⋅θ⋅λ⋅r(L) + 2⋅
──────────────────────────────────────────────────────────────────────────────


         2
R_M⋅R_W⋅λ ⋅r(L) - 4⋅R_M⋅R_W⋅λ⋅r(L) + 8⋅R_M⋅θ⋅λ⋅r(L) - 16⋅R_M⋅θ⋅r(L) - 4⋅R_M⋅λ⋅
──────────────────────────────────────────────────────────────────────────────


                 ⎞
r(L) + 8⋅R_M⋅r(L)⎠  2⋅R_B⋅R_M⋅R_W⋅θ⋅λ⋅f(I) + 2⋅R_B⋅R_M⋅R_W⋅λ⋅f(I) + 8⋅R_B⋅R_M⋅
──────────────────, ──────────────────────────────────────────────────────────



θ⋅f(I) - 4⋅R_B⋅R_M⋅f(I) - 4⋅R_B⋅R_W⋅θ⋅λ⋅r(L) - 4⋅R_B⋅R_W⋅λ⋅r(L) - 16⋅R_B⋅θ⋅r(L
──────────────────────────────────────────────────────────────────────────────


                    2    2    2             2    2    2           2    2  2
) + 8⋅R_B⋅r(L) - R_M ⋅R_W ⋅θ⋅λ ⋅f(I) - 8⋅R_M ⋅R_W ⋅θ⋅λ ⋅r(L) - R_M ⋅R_W ⋅λ ⋅f(
──────────────────────────────────────────────────────────────────────────────
                                ⎛     2    2        2  2          2
            (R_M⋅f(I) - 2⋅r(L))⋅⎝2⋅R_W ⋅θ⋅λ  - 2⋅R_W ⋅λ  - R_W⋅θ⋅λ  + 3⋅R_W⋅θ⋅
          2    2  2             2                     2                     2
I) + 8⋅R_M ⋅R_W ⋅λ ⋅r(L) - 4⋅R_M ⋅R_W⋅θ⋅λ⋅f(I) - 4⋅R_M ⋅R_W⋅θ⋅λ⋅r(L) + 2⋅R_M ⋅
──────────────────────────────────────────────────────────────────────────────
         2                                ⎞
λ - R_W⋅λ  + R_W⋅λ - 4⋅θ⋅λ + 8⋅θ + 2⋅λ - 4⎠
                  2                       2    2                 2  2
R_W⋅λ⋅f(I) + 4⋅R_M ⋅R_W⋅λ⋅r(L) + 2⋅R_M⋅R_W ⋅θ⋅λ ⋅r(L) + 2⋅R_M⋅R_W ⋅λ ⋅r(L) + 8
──────────────────────────────────────────────────────────────────────────────


                                        ⎛
⋅R_M⋅R_W⋅θ⋅λ⋅r(L) - 4⋅R_M⋅R_W⋅λ⋅r(L)  θ⋅⎝2⋅R_B⋅R_M⋅R_W⋅θ⋅λ⋅f(I) + 2⋅R_B⋅R_M⋅R_
────────────────────────────────────, ────────────────────────────────────────



W⋅λ⋅f(I) + 8⋅R_B⋅R_M⋅θ⋅f(I) - 4⋅R_B⋅R_M⋅f(I) - 4⋅R_B⋅R_W⋅θ⋅λ⋅r(L) - 4⋅R_B⋅R_W⋅
──────────────────────────────────────────────────────────────────────────────


                                         2    2    2             2    2    2
λ⋅r(L) - 16⋅R_B⋅θ⋅r(L) + 8⋅R_B⋅r(L) - R_M ⋅R_W ⋅θ⋅λ ⋅f(I) - 8⋅R_M ⋅R_W ⋅θ⋅λ ⋅r
──────────────────────────────────────────────────────────────────────────────
                                                    ⎛     2    2        2  2
                                (R_M⋅f(I) - 2⋅r(L))⋅⎝2⋅R_W ⋅θ⋅λ  - 2⋅R_W ⋅λ  -
         2    2  2             2    2  2             2                     2
(L) - R_M ⋅R_W ⋅λ ⋅f(I) + 8⋅R_M ⋅R_W ⋅λ ⋅r(L) - 4⋅R_M ⋅R_W⋅θ⋅λ⋅f(I) - 4⋅R_M ⋅R
──────────────────────────────────────────────────────────────────────────────
        2                    2                                ⎞
 R_W⋅θ⋅λ  + 3⋅R_W⋅θ⋅λ - R_W⋅λ  + R_W⋅λ - 4⋅θ⋅λ + 8⋅θ + 2⋅λ - 4⎠
                   2                   2                       2    2
_W⋅θ⋅λ⋅r(L) + 2⋅R_M ⋅R_W⋅λ⋅f(I) + 4⋅R_M ⋅R_W⋅λ⋅r(L) + 2⋅R_M⋅R_W ⋅θ⋅λ ⋅r(L) + 2
──────────────────────────────────────────────────────────────────────────────


        2  2                                             ⎞
⋅R_M⋅R_W ⋅λ ⋅r(L) + 8⋅R_M⋅R_W⋅θ⋅λ⋅r(L) - 4⋅R_M⋅R_W⋅λ⋅r(L)⎠
──────────────────────────────────────────────────────────, ──────────────────
...
f(I) - 4⋅R_B⋅R_M⋅R_W⋅λ⋅f(I) + 2⋅R_B⋅R_M⋅θ⋅f(I) - 2⋅R_B⋅R_M⋅f(I) - 8⋅R_B⋅R_W⋅θ⋅


──────────────────────────────────────────────────────────────────────────────
                                                           2        2
λ⋅r(L) + 8⋅R_B⋅R_W⋅λ⋅r(L) - 4⋅R_B⋅θ⋅r(L) + 4⋅R_B⋅r(L) - R_M ⋅R_W⋅θ⋅λ ⋅f(I) - 8

                                                                R_B⋅(R_M⋅f(I)
──────────────────────────────────────────────────────────────────────────────
    2        2             2                      2                   2      2
⋅R_M ⋅R_W⋅θ⋅λ ⋅r(L) + 2⋅R_M ⋅R_W⋅θ⋅λ⋅f(I) + 16⋅R_M ⋅R_W⋅θ⋅λ⋅r(L) - R_M ⋅R_W⋅λ
          ⎛     2    2        2  2          2                    2
- 2⋅r(L))⋅⎝2⋅R_W ⋅θ⋅λ  - 2⋅R_W ⋅λ  - R_W⋅θ⋅λ  + 3⋅R_W⋅θ⋅λ - R_W⋅λ  + R_W⋅λ - 4
──────────────────────────────────────────────────────────────────────────────
             2      2             2                    2                   2
⋅f(I) + 8⋅R_M ⋅R_W⋅λ ⋅r(L) + 2⋅R_M ⋅R_W⋅λ⋅f(I) - 16⋅R_M ⋅R_W⋅λ⋅r(L) - 4⋅R_M ⋅θ
                    ⎞
⋅θ⋅λ + 8⋅θ + 2⋅λ - 4⎠
──────────────────────────────────────────────────────────────────────────────
               2                 2               2               2
⋅λ⋅f(I) - 4⋅R_M ⋅θ⋅λ⋅r(L) + 8⋅R_M ⋅θ⋅f(I) + 8⋅R_M ⋅θ⋅r(L) + 2⋅R_M ⋅λ⋅f(I) + 4⋅


──────────────────────────────────────────────────────────────────────────────
   2               2             2                     2
R_M ⋅λ⋅r(L) - 4⋅R_M ⋅f(I) - 8⋅R_M ⋅r(L) + 2⋅R_M⋅R_W⋅θ⋅λ ⋅r(L) - 4⋅R_M⋅R_W⋅θ⋅λ⋅


──────────────────────────────────────────────────────────────────────────────
                  2
r(L) + 2⋅R_M⋅R_W⋅λ ⋅r(L) - 4⋅R_M⋅R_W⋅λ⋅r(L) + 8⋅R_M⋅θ⋅λ⋅r(L) - 16⋅R_M⋅θ⋅r(L) -
                                            2               2
                                      -2⋅R_M          -2⋅R_M ⋅r(L)     -R_M⋅(R
──────────────────────────, R_B, ─────────────────, ─────────────────, ───────
                                 R_M⋅f(I) - 2⋅r(L)  R_M⋅f(I) - 2⋅r(L)      R_M
 4⋅R_M⋅λ⋅r(L) + 8⋅R_M⋅r(L)
                             ⎛                                 2
_M⋅f(I) + 2⋅r(L))         -θ⋅⎝2⋅R_B⋅R_M⋅f(I) - 4⋅R_B⋅r(L) - R_M ⋅R_W⋅λ⋅f(I) -
──────────────────, ──────────────────────────────────────────────────────────
⋅f(I) - 2⋅r(L)                            ⎛     2    2        2  2          2
                    α⋅(R_M⋅f(I) - 2⋅r(L))⋅⎝2⋅R_W ⋅θ⋅λ  - 2⋅R_W ⋅λ  - R_W⋅θ⋅λ
     2               2                        ⎞
4⋅R_M ⋅λ⋅r(L) + 8⋅R_M ⋅r(L) + 2⋅R_M⋅R_W⋅λ⋅r(L)⎠
─────────────────────────────────────────────────────, ───────────────────────
                   2                                ⎞    ⎛         2    2
+ 3⋅R_W⋅θ⋅λ - R_W⋅λ  + R_W⋅λ - 4⋅θ⋅λ + 8⋅θ + 2⋅λ - 4⎠  α⋅⎝2⋅R_M⋅R_W ⋅θ⋅λ ⋅f(I)


──────────────────────────────────────────────────────────────────────────────
            2  2                   2                                      2
 - 2⋅R_M⋅R_W ⋅λ ⋅f(I) - R_M⋅R_W⋅θ⋅λ ⋅f(I) + 3⋅R_M⋅R_W⋅θ⋅λ⋅f(I) - R_M⋅R_W⋅λ ⋅f(
                   ⎛                                 2                   2
          -R_W⋅θ⋅λ⋅⎝2⋅R_B⋅R_M⋅f(I) - 4⋅R_B⋅r(L) - R_M ⋅R_W⋅λ⋅f(I) - 4⋅R_M ⋅λ⋅r
──────────────────────────────────────────────────────────────────────────────

I) + R_M⋅R_W⋅λ⋅f(I) - 4⋅R_M⋅θ⋅λ⋅f(I) + 8⋅R_M⋅θ⋅f(I) + 2⋅R_M⋅λ⋅f(I) - 4⋅R_M⋅f(I
           2                        ⎞
(L) + 8⋅R_M ⋅r(L) + 2⋅R_M⋅R_W⋅λ⋅r(L)⎠
──────────────────────────────────────────────────────────────────────────────
         2    2             2  2                 2
) - 4⋅R_W ⋅θ⋅λ ⋅r(L) + 4⋅R_W ⋅λ ⋅r(L) + 2⋅R_W⋅θ⋅λ ⋅r(L) - 6⋅R_W⋅θ⋅λ⋅r(L) + 2⋅R
                                                                       ⎞⎤
                                                                       ⎟⎥
───────────────────────────────────────────────────────────────────────⎟⎥
    2                                                                 ⎞⎟⎥
_W⋅λ ⋅r(L) - 2⋅R_W⋅λ⋅r(L) + 8⋅θ⋅λ⋅r(L) - 16⋅θ⋅r(L) - 4⋅λ⋅r(L) + 8⋅r(L)⎠⎠⎦
